...
if (typeof(value) == "string") {
    console.log("Es un valor de tipo: STRING");
} else if (typeof(value) == "number") {
    console.log("Es un valor de tipo: NUMBER");
} else {
    console.log("No es un valor de tipo STRING o NUMBER")
};
...
//Escribe tu código aquí
for (let i = 0; i <= (programmers.length - 1); i++) {
